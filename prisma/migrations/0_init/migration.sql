...
-- AddForeignKey
ALTER TABLE "account"."permission_on_role" ADD CONSTRAINT "permission_on_role_permission_fkey" FOREIGN KEY ("permission") REFERENCES "account"."permission"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
