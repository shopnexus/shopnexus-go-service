...
var _ S3ServiceInterface = (*S3Client)(nil)
...
func (s *S3Client) Upload(ctx context.Context, key string, body io.Reader, private bool) (string, error) {
	prefix := "public/"
	if private {
		prefix = "private/"
	}
...
func (s *S3Client) GetPresignedURL(ctx context.Context, key string, expireIn time.Duration) (string, error) {
