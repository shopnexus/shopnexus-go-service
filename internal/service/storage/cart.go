...
func (r *ServiceImpl) ExistsCart(ctx context.Context, userID int64) (bool, error) {
	return r.sqlc.ExistsCart(ctx, userID)
}

// CreateCart creates a new cart for the user
func (r *ServiceImpl) CreateCart(ctx context.Context, userID int64) error {
...
func (r *ServiceImpl) GetCart(ctx context.Context, params GetCartParams) (model.Cart, error) {
...
func (r *ServiceImpl) AddCartItem(ctx context.Context, params AddCartItemParams) (int64, error) {
...
func (r *ServiceImpl) UpdateCartItem(ctx context.Context, params UpdateCartItemParams) (int64, error) {
...
func (r *ServiceImpl) RemoveCartItem(ctx context.Context, cartID int64, productIDs []int64) error {
...
func (r *ServiceImpl) ClearCart(ctx context.Context, cartID int64) error {
