...
func (s *AccountService) GenerateAccessToken(account model.Account) (string, error) {
...
func (s *AccountService) ValidateAccessToken(tokenStr string) (claims model.Claims, err error) {
	secret := config.GetConfig().SensitiveKeys.JWTSecret
